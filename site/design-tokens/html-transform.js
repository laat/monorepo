...
class Styleguide {
  ...
  renderBorderStyle(props) {
    return props.map(prop => {
      let example = html`<td style="border: ${prop.value};"></td>`;
      return this.renderRow(prop, example);
    });
  }
  ...
  renderBorderColor(props) {
    return props.map(prop => {
      let example = html`<td style="border: 2px solid ${prop.value};"></td>`;
      return this.renderRow(prop, example);
    });
  }
  ...
  renderBackgroundColor(props) {
    return props.map(prop => {
      let example = html`<td style="background-color: ${prop.value}; border: 1px solid #f6f6f6;"></td>`;
      return this.renderRow(prop, example);
    });
  }
  ...
  renderGradient(props) {
    return props.map(prop => {
      let example = html`<td style="background: ${prop.value};"></td>`;
      return this.renderRow(prop, example);
    });
  }
  ...
  renderBackgroundGradient(props) {
    return props.map(prop => {
      let example = html`<td style="background-image: ${prop.value};"></td>`;
      return this.renderRow(prop, example);
    });
  }
  ...
  renderDropShadow(props) {
    return props.map(prop => {
      let example = html`<td style="box-shadow: ${prop.value};"></td>`;
      return this.renderRow(prop, example);
    });
  }
...
module.exports = theo => {
  theo.registerFormat("html", result => {
